			...
			if ( $newsposts ) : ?>
				...
				<div class="sidebar-item">
					...
					<div class="row">
						<div class="small-12 columns">
							<div class="news">
								<?php if ( $postcount === 0 && has_post_thumbnail() ) :
			...
			<div class="sidebar-item">
				<div class="row">
					<div class="small-12 columns">
						...
						<?php echo do_shortcode('[twitter-feed username="Tcfacilitiesmgt" followlink="no" followbutton="no" img="no" conditional="no" phptime="d.m.y" tweetintent="no" num="1" ulclass="twitter-updates" liclass="tweetli" smalltimeclass="tweettime"]'); ?>
					</div>
				</div>
			</div>
