<?php
class pxls_Options_google_webfonts extends pxls_Options{	
	...
	*/
	function __construct($field = array(), $value ='', $parent){
		...
		$fonts = get_transient('pxls-opts-google-webfonts');
		if(!is_array(json_decode($fonts))){
			...
			set_transient('pxls-opts-google-webfonts', $fonts, 60 * 60 * 24);
